...
diag_log("MISSION 1: Mission Name - Script Started");

_missionSpawnChance =  .50; //Set Spawn Chance Here 1 = always
_spawnRoll = random 1;

diag_log("MISSION 1: Mission Name - Checking MissionSpawnChance");
if (_spawnRoll > _missionSpawnChance) exitWith 
{
diag_log format ["MISSION 1: Mission Name - Failed with %1 it needed to be lower than %2",_spawnRoll,_missionSpawnChance];
};

sleep .5;
diag_log("MISSION 1: Mission Name - Mission SpawnChance Success");

sleep .5;
diag_log("MISSION 1: Mission Name - Mission Script Started");
...
// Clean up
		...
		diag_log("MISSION 1: Mission Name - Script Finished");	