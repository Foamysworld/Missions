/*
	...
	File Description: XXXXXX (M2)
	Template by: Foamy

*/

// CHECK FOR ANOTHER MISSION 2 RUNNING START ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

	if (isNil "EPOCH_MISSION2_RUNNING") then 
	{
	EPOCH_MISSION2_RUNNING = false;
	};

	if (EPOCH_MISSION2_RUNNING) exitWith 
	{
	diag_log("MISSION 2 already running");
	};

// CHECK FOR ANOTHER MISSION 2 RUNNING END ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
diag_log("MISSION 2: Mission Name - Script Started");

_missionSpawnChance =  .50; //Set Spawn Chance Here 1 = always
_spawnRoll = random 1;

diag_log("MISSION 2: Mission Name - Checking MissionSpawnChance");
if (_spawnRoll > _missionSpawnChance) exitWith 
{
diag_log format ["MISSION 2: Mission Name - Failed with %1 it needed to be lower than %2",_spawnRoll,_missionSpawnChance];
};

sleep .5;
diag_log("MISSION 2: Mission Name - Mission SpawnChance Success");

sleep .5;
diag_log("MISSION 2: Mission Name - Mission Script Started");

EPOCH_MISSION2_RUNNING = true;
...
// Add a Marker? Make sure to use FMarker2.sqf for M2 Missions
...
_aiunitX = [_aiunit_spawn_pos,50,4,"Bandit",_loot_pos,"M2"] execVM "\z\addons\dayz_server\addons\FMission\FAI\FAI_Create_Unit.sqf";
...
// Add a Heli Patrol?
_aiHeliX = [_aiheli_spawn_pos,_loot_pos,250,"M2"] execVM "\z\addons\dayz_server\addons\FAI\FMission\FAI_Create_Heli.sqf";

// Add a Vehicle patrols?
_aiVehicleX = [_aivehicle_spawn_pos,_loot_pos,100,"M2"] execVM "\z\addons\dayz_server\addons\FMission\FAI\FAI_Create_Vehicle.sqf";


// Create a loot box?
		// Create loot box
		diag_log("MISSION 2: Mission Name - Creating loot box");
		...
		// Add loot
		diag_log("MISSION 2: Mission Name - Loot box created, adding loot to loot box");
		{
...
// Clean up
		...
		diag_log("MISSION 2: Mission Name - Script Finished");	